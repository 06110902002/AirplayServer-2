...
struct raop_callbacks_s {
	...
	void  (*onAVStop)(void* cls,int type);
};
...
RAOP_API void raop_set_airplay(raop_t *raop, unsigned char *bytes, size_t len);
RAOP_API void raop_set_raop(raop_t *raop, unsigned char *bytes, size_t len);
